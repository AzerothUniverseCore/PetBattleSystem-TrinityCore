...
CREATE TABLE IF NOT EXISTS `bp_pet_info` (
    ...
    `cant_dano_1` INT NOT NULL DEFAULT 0,
    `cant_dano_2` INT NOT NULL DEFAULT 0,
    `cant_dano_3` INT NOT NULL DEFAULT 0,
...
VALUES
    ...
    (57,
     ...
     '{0} ataca causando {1} de dano{2}. Vida restante de la mascota rival: {3}',
